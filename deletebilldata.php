...
<h1>DELETE BILL</h1>
<h2>Enter bill ID to delete</h2>
<ul>
    <form name="deletebilldata" action="deletebilldata.php" method="POST" >
...
$sql = "DELETE FROM bill WHERE billid = $_POST[billid]";
