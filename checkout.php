...
<body data-gr-c-s-loaded="true"><div class="ddshadow toplevelshadow" style="left: 471.313px; top: 175px; width: 190px; height: 0px; display: block; overflow: hidden;"></div><div class="ddshadow toplevelshadow" style="left: 365.625px; top: 175px;"></div>

<div id="templatemo_body_wrapper">
<div id="templatemo_wrapper">

	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="checkout.php#">Online Shoes Store</a></h1></div>
        <div id="header_right">
        	<p>
	        <a href="checkout.php#">My Account</a> | <a href="checkout.php#">My Wishlist</a> | <a href="checkout.php#">My Cart</a> | <a href="checkout.php#">Checkout</a> | <a href="checkout.php#">Log In</a></p>
            <p>
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li style="z-index: 99;"><a href="about.php" class="">About</a>
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
          ...
          PHONE<br>
			...
			I accept the <a href="checkout.php#">terms of use</a> of this website.</p>
            <table style="border:1px solid #CCCCCC;" width="100%">
                <tbody><tr>
                    ...
                    <td><a href="checkout.php#" class="more">PAYPAL</a></td>
                </tr>
                <tr>
                    ...
                    <td><a href="checkout.php#" class="more">2CHECKOUT</a></td>
                </tr>
            </tbody></table>
        </div> 
        <div class="cleaner"></div>
    ...
    <div id="templatemo_footer">
    	<p><a href="checkout.php#">Home</a> | <a href="checkout.php#">Products</a> | <a href="checkout.php#">About</a> | <a href="checkout.php#">FAQs</a> | <a href="checkout.php#">Checkout</a> | <a href="checkout.php#">Contact Us</a>
		</p>

		Copyright © 2072 <a href="checkout.php#">Your Company Name</a> <!-- Credit: www.templatemo.com -->
