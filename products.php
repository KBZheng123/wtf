...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="products.php#">Online Shoes Store</a></h1></div>
        <div id="header_right">
        	<p>
	        <a href="products.php#">My Account</a> | <a href="products.php#">My Wishlist</a> | <a href="products.php#">My Cart</a> | <a href="products.php#">Checkout</a> | <a href="products.php#">Log In</a></p>
            <p>
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li style="z-index: 100;"><a href="products.php" class="selected">Products</a>
    ...
    <div id="templatemo_footer">
    	<p><a href="products.php#">Home</a> | <a href="products.php#">Products</a> | <a href="products.php#">About</a> | <a href="products.php#">FAQs</a> | <a href="products.php#">Checkout</a> | <a href="products.php#">Contact Us</a>
		</p>


    	Copyright © 2072 <a href="products.php#">Your Company Name</a> <!-- Credit: www.templatemo.com -->
